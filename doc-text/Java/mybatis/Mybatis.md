...
- 单个条件成立
  ...
  - 输出结果  1行记录：返回条件成立的结果集，不执行\<otherwise>标签
    ...
    ![image-20200902014143471](/mybatis/image-20200902014143471.png)
...
- 多个条件成立
  ...
  - 输出结果 => 多个成立条件中的第一个（即：and title = #{title} ），返回其结果
    ...
    ![image-20200902014802662](/mybatis/image-20200902014802662.png)
...
- \<when>都为false，\<otherwise>为true
  ...
  - 输出结果： 4行记录 =>  跳过所有条件(false)，最后执行\<otherwise>标签
    ...
    ![image-20200902011631180](/mybatis/image-20200902011631180.png)
...
4. 输出结果
   ...
   ![image-20200905172623399](/mybatis/image-20200905172623399.png)
...
4. 测试结果
   ...
   ![image-20200906140646662](/mybatis/image-20200906140646662.png)

   ![image-20200906140746439](/mybatis/image-20200906140746439.png)
...
5. 日志输出
   ...
   1. 正常输出
      ...
      ![image-20200906160417329](/mybatis/image-20200906160417329.png)

   2. 清空SqlSession

      ![image-20200906162225130](/mybatis/image-20200906162225130.png)
...
![image-20200906163007251](/mybatis/image-20200906163007251.png)
...
3. 测试commit操作
   ...
   ​	![image-20200906165733200](/mybatis/image-20200906165733200.png)