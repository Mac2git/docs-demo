...
![1595415587435](/SpringBoot-images/SpringBoot02：运行原理初探.assets/1595415587435.png)

**WebMvcAutoConfiguration**

我们在上面的自动配置类随便找一个打开看看，比如 ：`WebMvcAutoConfiguration`

![1595416894611](/SpringBoot-images/SpringBoot02：运行原理初探.assets/1595416894611.png)
