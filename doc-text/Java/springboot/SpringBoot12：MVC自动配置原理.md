...
2. 我们给 DispatcherServlet 中的 doDispatch方法 加个断点进行调试一下，因为所有的请求都会走到这个方法中
   ...
   ![1595564720595](/SpringBoot-images/SpringBoot12：MVC自动配置原理.assets/1595564720595.png)

3. 我们启动我们的项目，然后随便访问一个页面，看一下Debug信息；

   找到this(<font color=red>就是DispatcherServlet</font>)

   ![1595564823239](/SpringBoot-images/SpringBoot12：MVC自动配置原理.assets/1595564823239.png)

   找到视图解析器（<font color=red>viewResolvers</font>），我们看到我们自己定义的就在这里了；

   ![1595564942873](/SpringBoot-images/SpringBoot12：MVC自动配置原理.assets/1595564942873.png)
...
- 我们去浏览器访问一下：
  ...
  ![1595584684727](/SpringBoot-images/SpringBoot12：MVC自动配置原理.assets/1595584684727.png)
...
- 不加注解之前，访问首页：
  ...
  ![1595587645715](/SpringBoot-images/SpringBoot12：MVC自动配置原理.assets/1595587645715.png)

- 给配置类加上注解：`@EnableWebMvc`

  我们发现所有的SpringMVC自动配置都失效了！回归到了最初的样子；

  ![1595587533039](/SpringBoot-images/SpringBoot12：MVC自动配置原理.assets/1595587533039.png)
