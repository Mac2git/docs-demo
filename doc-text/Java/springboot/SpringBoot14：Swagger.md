...
2. 重启项目测试，由于我们配置根据包的路径扫描接口，所以我们只能看到一个类
   ...
   ![image-20200731165837391](/SpringBoot-images/swagger/image-20200731165837391.png)
...
![image-20200731190614381](/SpringBoot-images/swagger/image-20200731190614381.png)
...
3. 可以在项目中增加配置文件
   ...
   - dev测试环境
       ...
       ![image-20200731193109826](/SpringBoot-images/swagger/image-20200731193109826.png)
       
       项目运行结果
       
       ![image-20200731193425090](/SpringBoot-images/swagger/image-20200731193425090.png)
   ...
   - pro测试环境
       ...
       ![image-20200731194455510](/SpringBoot-images/swagger/image-20200731194455510.png)
   
       项目运行结果
   
       ![image-20200731194559290](/SpringBoot-images/swagger/image-20200731194559290.png)
...
2. 重启项目查看分组
   ...
   ![image-20200731195354714](/SpringBoot-images/swagger/image-20200731195354714.png)
...
4. 重启项目查看即可
   ...
   ![image-20200731195543102](/SpringBoot-images/swagger/image-20200731195543102.png)
...
3. 重启查看测试
   ...
   ![image-20200731200413725](/SpringBoot-images/swagger/image-20200731200413725.png)
...
1. 在HelloController控制类中的接口添加api接口注释
   ...
   ![image-20200731201755001](/SpringBoot-images/swagger/image-20200731201755001.png)

5. 进行try it out测试

   ![image-20200731202958255](/SpringBoot-images/swagger/image-20200731202958255.png)

   测试结果

   ![image-20200731203034702](/SpringBoot-images/swagger/image-20200731203034702.png)
