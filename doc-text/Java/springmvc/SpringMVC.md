...
**最典型的MVC就是JSP + servlet + javabean的模式。**![640](/springmvc/640.png)
...
![1594598769272](/springmvc/1594598769272.png)
...
- Spring的web框架围绕DispatcherServlet设计。DispatcherServlet的作用是将请求分发到不同的处理器。从Spring 2.5开始，使用Java 5或者以上版本的用户可以采用基于注解的controller声明方式。
  ...
  ![1594600307868](/springmvc/1594600307868.png)
...
![1594603929224](/springmvc/1594603929224.png)

### 2.3、SpringMVC执行原理

![1594606134497](/springmvc/1594606134497.png)
...
![1595124994780](/springmvc/1595124994780.png)
...
9. **配置Tomcat运行**
   ...
   ![1594622304382](/springmvc/1594622304382.png)
...
6. 配置Tomcat运行测试，我这里没有项目发布名配置的就是一个 / ，所以请求不用加项目名，OK！
   ...
   ![1595128496794](/springmvc/1595128496794.png)
...
- 运行tomcat测试
  ...
  ![1595128649687](/springmvc/1595128649687.png)
...
3. 我们来测试请求查看下
   ...
   ![1595129216809](/springmvc/1595129216809.png)
...
4. 思考：使用路径变量的好处？
   ...
   - 通过路径变量的类型可以约束访问参数，如果类型不一样，则访问不到对应的请求方法，如这里访问是的路径是/add/1/a，则路径与方法不匹配，而不会是参数转换失败。
     ...
     ![1595129271494](/springmvc/1595129271494.png)
...
6. 我们来修改下对应的参数类型，再次测试
   ...
   ![1595129577077](/springmvc/1595129577077.png)
...
- 我们使用浏览器地址栏进行访问默认是Get请求，会报错405：
  ...
  ![1595129829057](/springmvc/1595129829057.png)
...
- 如果将POST修改为GET则正常了；
  ...
  ![1595129889298](/springmvc/1595129889298.png)
...
3. 输入中文测试，发现乱码
   ...
   ![1595131750549](/springmvc/1595131750549.png)
...
- 配置SpringMVC需要的配置
  ...
  - 配置Tomcat ， 启动测试一下！http://localhost:8080/json1
    ...
    ![1595133634951](/springmvc/1595133634951.png)
...
![1595133587875](/springmvc/1595133587875.png)
...
- 运行结果 :
    ...
    ![1595134256420](/springmvc/1595134256420.png)
...
![1595134398126](/springmvc/1595134398126.png)
...
4. 测试一下效果，动态请求响应，局部刷新，就是如此！
   ...
   ![1595137816208](/springmvc/1595137816208.png)
...
2. 测试
   ...
   ![1595138107341](/springmvc/1595138107341.png)
...
![1595139309383](/springmvc/1595139309383.png)
